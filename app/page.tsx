      ...
      <section className="relative h-[700px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex items-center">
          <div className="max-w-4xl">
            ...
            <Link
              href="/products"
              className="inline-flex items-center bg-brand-teal text-white px-10 py-4 rounded-lg text-lg font-semibold hover:bg-brand-teal/90 transform hover:scale-105 transition-all duration-300 shadow-lg"
            >
        ...
        <div className="absolute bottom-8 right-8 flex flex-col space-y-3">
          <div className="bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-lg">
            <svg className="w-4 h-4 inline mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            Gold Standard
          </div>
          <div className="bg-brand-teal text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-lg">
            <svg className="w-4 h-4 inline mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z" />
            </svg>
            Crowd Favorite
          </div>
          <div className="bg-yellow-600 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-lg">
            <svg className="w-4 h-4 inline mr-2" fill="currentColor" viewBox="0 0 20 20">
